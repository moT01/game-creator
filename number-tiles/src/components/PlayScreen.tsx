...
export function PlayScreen({
  ...
  useEffect(() => {
    if (gameState.won) {
      setAnnouncement(`Puzzle solved in ${gameState.moves} moves, ${formatTime(gameState.elapsedSeconds)}`);
    } else if (gameState.moves > 0) {
      setAnnouncement(`Move ${gameState.moves}`);
    }
  }, [gameState.moves, gameState.won, gameState.elapsedSeconds]);
      ...
      <div className="play-screen__card">
        <div className="play-screen__top-bar">
          <button className="btn btn-secondary icon-btn" onClick={handleHomeRequest} aria-label="Close">
            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 384 512"><path d="M376.6 84.5c11.3-13.6 9.5-33.8-4.1-45.1s-33.8-9.5-45.1 4.1L192 206 56.6 43.5C45.3 29.9 25.1 28.1 11.5 39.4S-3.9 70.9 7.4 84.5L150.3 256 7.4 427.5c-11.3 13.6-9.5 33.8 4.1 45.1s33.8 9.5 45.1-4.1L192 306 327.4 468.5c11.3 13.6 31.5 15.4 45.1 4.1s15.4-31.5 4.1-45.1L233.7 256 376.6 84.5z"/></svg>
          </button>
          ...
          <div className="play-screen__top-actions">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 512 512"><path d="M241 87.1l15 20.7 15-20.7C296 52.5 336.2 32 378.9 32 452.4 32 512 91.6 512 165.1l0 2.6c0 112.2-139.9 242.5-212.9 298.2-12.4 9.4-27.6 14.1-43.1 14.1s-30.8-4.6-43.1-14.1C139.9 410.2 0 279.9 0 167.7l0-2.6C0 91.6 59.6 32 133.1 32 175.8 32 216 52.5 241 87.1z"/></svg>
            </a>
          </div>
        </div>
