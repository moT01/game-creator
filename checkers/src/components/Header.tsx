  ...
  return (
    <header className="game-header">
      ...
      <div className="game-header__center">
        <span className={`game-header__status ${statusClass ?? ''}`} aria-live="polite" aria-atomic="true">{statusText}</span>
      </div>
      <div className="game-header__right">
        ...
        <button className="icon-btn" onClick={onThemeToggle} aria-label="Toggle theme">
          {theme === 'dark' ? (
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="currentColor">
